...
export const CLOCK_CONTROLS_CONFIGS: ControlsConfigs<ClockSettings> = {
  digitalClockSize: { min: 1, max: 100, step: 1 },
  analogClockSize: { min: 1, max: 100, step: 1 },
...
export const RANDOMIZATION_PRESETS: RandomizationPreset[] = [
  ...
  {
    presetType: "color",
    name: "Colorful (No BG Rand.)",
    isBasePreset: true,
    enabled: false,
    settings: {
      ...DEFAULT_COLOR_RANDOMIZATION_SETTINGS,
      backgroundColor: { type: "color", enabled: false },
    },
  },
];
