  ...
  return (
    <div className="mx-auto flex h-auto w-full max-w-sm flex-col bg-amber-200 p-1">
      ...
      <ControlContainer>
        ...
        <SlimeStoreSlider
          label="Phase"
          storePath={["colorSettings", "proceduralColorPalette", "r", "phase"]}
          onChange={(value) =>
      ...
      <ControlContainer>
        ...
        <SlimeStoreSlider
          label="Phase"
          storePath={["colorSettings", "proceduralColorPalette", "g", "phase"]}
          onChange={(value) =>
      ...
      <ControlContainer>
        ...
        <SlimeStoreSlider
          label="Phase"
          storePath={["colorSettings", "proceduralColorPalette", "b", "phase"]}
          onChange={(value) =>
